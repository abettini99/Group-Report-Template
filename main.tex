...
% \usepackage{chngcntr}   % https://ctan.org/pkg/chngcntr %% Change the resetting of counters by using \counterwithin (which sets up a counter to be reset when another is incremented) and \counterwithout (which unsets such a relationship). %%% ALREADY IN MEMOIR CLASS
...
\makeevenhead{appendix}{\thepage}{}{\itshape\MakeUppercase{Appendix \thesection~--~\leftmark}}
\makeoddhead{appendix}{\itshape\MakeUppercase{ Appendix \thesection~--~\leftmark}}{}{\thepage}
...
\newcommand{\Tu}{\mathrm{Tu}}                   % Turbulence level
...
%% standard /mapsto symbol, but reversed
% https://tex.stackexchange.com/questions/26508/left-version-of-mapsto
...
\renewcommand{\printtoctitle}[1]{\fontfamily{qhv}\selectfont\bfseries\huge#1}
\renewcommand{\printloftitle}[1]{\fontfamily{qhv}\selectfont\bfseries\huge#1}
\renewcommand{\printlottitle}[1]{\fontfamily{qhv}\selectfont\bfseries\huge#1}
...
\input{Chapters/00Nomenclature.tex}
\pagestyle{mystyle}
...
%\end{multicols}
\DeclareRobustCommand{\VAN}[0]{Van} % Change from van to Van for appendix purposes

\bookmarksetup{startatroot} % https://tex.stackexchange.com/questions/131959/pdf-bookmarks-for-references-and-index-appear-as-contained-in-the-appendix-wron/131966
